/**
 * نبراس hrws277 — siteText.zh (lazy)
 */
(function(global) {
    'use strict';
    ...
    global.siteText.zh = {
                ...
                nav: {
                    ...
                    worldWpcDoors: '<i class="fas fa-door-open"></i> WPC 门',
                    worldWpcReady: '<i class="fas fa-check-circle"></i> WPC 成品',
                    worldWpcRaw: '<i class="fas fa-industry"></i> WPC 素坯',
                    worldAluminum: '<i class="fas fa-border-all"></i> 铝材',
                ...
                doorDesignerCanvasHint: 'Nebras 工厂真实 WPC 门照片 — 每项选择即时换图 — 卷材色与房间协调',
                ...
                doorDesignerHeroSub: 'WPC 设计工作室 — 工厂实拍 360° 预览',
                ...
                doorDesigner3dHint: '工厂实拍门图 — 拖动 360° — 卷材色与房间协调',
