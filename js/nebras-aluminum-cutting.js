/**
 * نبراس — تخصيمات قطاعات الألومنيوم (V3 Pro · hrws222)
...
(function (global) {
    ...
    function aluDrawElevationSvg(item, opts) {
        ...
        if (shape.family === 'facade') {
            ...
            const foundSlide = findSystem(item.profileSystemId, 'sliding');
        ...
        /* شبكة جورجيا على الزجاج — مرئية للمهندس في الرسم */
    ...
    function aluDrawCutTicketSvg(cuts, opts) {
        opts = opts || {};
    ...
    function renderAluAudit() {
        ...
        const blocks = explained.map(function (ex) {
            ...
            const stepsHtml = (ex.formulaSteps || []).map(function (s) {
