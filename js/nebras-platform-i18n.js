/**
 * نبراس hrws336 — i18n: العربية فوراً · EN/ZH كسول عند تغيير اللغة
...
(function(global) {
    ...
    global.siteText = {
        ar: {
                ...
                visitorQuickColorRolls: 'كتالوج ألوان نبراس',
                ...
                otherProductsText: 'إكسسوارات أبواب WPC · فوم · سيليكون · رولات — والألوان من كتالوج نبراس. الأسعار من الإدارة.',
                ...
                colorCatalogTitle: 'كتالوج ألوان نبراس',
                colorCatalogSubtitle: 'ألوان وتشطيبات متوفرة ضمن خط إنتاج نبراس للبلاستيك.',
                colorCatalogBody: 'ألوان كتالوج نبراس الرسمية لاختيار اللون والكود. الرولات منتج منفصل داخل منتجات أخرى.',
                ...
                storeOtherPriceByHq: 'السعر من الإدارة الرئيسية',
                storeNebrasColorsCatalog: 'كتالوج الألوان',
                storeNebrasColorsOpen: 'فتح كتالوج ألوان نبراس',
