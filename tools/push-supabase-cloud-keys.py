...
# مطابق لـ supabase/014-nebras-master-cloud-sync.sql (64 مفتاح)
ALL_KEYS = {
    'site_products': [],
    'visitor_icons': [],
    'dashboard_tiles': [],
    ...
    'nebras_cloud_snapshots': {'byKey': {}, 'updatedAt': None},
    'nebras_platform_integrity': {'modules': {}, 'lastAuditAt': None},
