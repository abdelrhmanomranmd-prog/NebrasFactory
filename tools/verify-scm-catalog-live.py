...
checks = [
    ...
    ('linkProductToStoreHub', 'linkProductToStoreHub' in js),
    ('STORE_HUB_ICON_CATEGORIES', 'STORE_HUB_ICON_CATEGORIES' in js),
    ('repairStoreHubCatalogBindings', 'repairStoreHubCatalogBindings' in js),
