...
LIVE_MARKERS = {
    'index.html': [
        ...
        'data-nebras-deploy="hrws127"',
        'dash-customer-portal', 'openCustomerPortalGovernance', 'createCustomerUser',
        'customer_portal_users',
    ...
    'js/nebras-platform.js': [
        ...
        'dash-customer-portal', 'dash-create-customer', 'openCustomerPortalGovernance', 'createCustomerUser',
