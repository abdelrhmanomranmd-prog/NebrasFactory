...
LIVE_MARKERS = {
    'index.html': [
        ...
        'NEBRAS_CATALOG_CATEGORIES', 'renderScmProductCatalogPanel',
        'saveScmCatalogNow', 'syncScmCatalogStepsUi',
        'persistScmContentHonest', 'renderScmCloudSaveStatus', 'SCM_CONTENT_CLOUD_KEYS',
        'linkProductToStoreHub', 'STORE_HUB_ICON_CATEGORIES', 'repairStoreHubCatalogBindings',
    ...
    'js/nebras-platform.js': [
        ...
        'dash-customer-portal', 'dash-create-customer-portal', 'openCpUserEditorNew',
        'NEBRAS_PERMISSION_GROUPS', 'buildUserEditorPermissionGroupsHtml',
        'NEBRAS_CATALOG_CATEGORIES', 'renderScmProductCatalogPanel', 'saveScmCatalogNow', 'syncScmCatalogStepsUi',
        'persistScmContentHonest', 'renderScmCloudSaveStatus', 'SCM_CONTENT_CLOUD_KEYS',
        'linkProductToStoreHub', 'STORE_HUB_ICON_CATEGORIES', 'repairStoreHubCatalogBindings',
        ...
        'pullPublicSiteGovernanceFromCloud', 'startNebrasPublicSiteCloudRefresh',
        'window.pullPublicSiteGovernanceFromCloud',
        'getNebrasPaymentMethods', 'openSystemSettingsForPayments', 'paymentMethods',
        'cart-drawer--v2', 'ensurePaymentMethodsDefaults', 'visitorPaymentsGovernance', 'publishVisitorPaymentsToStorefront', 'openVisitorPaymentsGovernance',
